...
$_['help_recurring_status']                             = 'Включите, чтобы разрешать периодические платежи. <br> ПРИМЕЧАНИЕ. Также необходимо настроить ежедневную задачу CRON.';
...
$_['text_confirm_cancel']                               = 'Вы уверены, что хотите отменить периодические платежи?';
...
$_['text_ok']                                           = 'ОК';
$_['text_order_history_cancel']                         = 'Администратор отменил Ваши периодические платежи. Ваша карта больше не будет списана.';
