 ...
 * @file       admin/language/ru-ru/extension/payment/amazon_login_pay.php
 * @author     Hkr32
...
$_['text_info_buyer_multi_currencies'] = 'Это расширение поддерживает функцию Multi-Currency. Если вы хотите использовать ее, пожалуйста, убедитесь, что вы включили хотя бы одну из <a href="https://pay.amazon.co.uk/help/5BDCWHCUC27485L"><b>поддерживаемых валют Amazon Pay</b></a> в настройках вашего онлайн-магазина <b><a href="index.php?route=localisation/currency&user_token=%s">(%s > %s > %s )</b></a>, и затем включите функцию <b>мульти валюты</b>';
...
$_['entry_capture_status']         = 'Статус для автоматического получения';
$_['entry_pending_status']         = 'Статус отложенного заказа';
$_['entry_capture_oc_status']      = 'Статус заказа для автоматического получения';
$_['entry_ipn_url']                = 'URL уведомления о мгновенном платеже';
$_['entry_ipn_token']              = 'Секретный токен';
$_['entry_debug']                  = 'Журнал отладки';

// Help
$_['help_pay_mode']                = 'Выберите Оплату, если вы хотите, чтобы платеж автоматически получался, или Авторизацию, чтобы получать его вручную';
...
$_['help_capture_oc_status']       = 'Выберите статус заказа после списания в Amazon Seller Central или через функцию получения в Админ-панели: %s > %s > %s.';
...
$_['help_buyer_multi_currency']    = 'Включите эту опцию, если вы хотите, чтобы покупатель мог покупать в любой из поддерживаемых валют Amazon Pay, доступных в вашем онлайн-магазине: %s';
$_['help_buyer_multi_currency_no_available_currency'] = 'Нет <a href="https://pay.amazon.co.uk/help/5BDCWHCUC27485L"><b>поддерживаемых валют Amazon Pay</b></a> в вашем онлайн-магазине, пожалуйста, добавьте/включите такие валюты, чтобы использовать эту функцию.';
...
$_['error_no_supported_currencies'] = 'Нет поддерживаемых валют доступных в вашем магазине, пожалуйста, добавьте/включите поддерживаемые валюты Buyer Multi-Currency, чтобы использовать эту функцию.';
