...
$_['entry_product_ids']             = 'Исключенные идентификаторы продуктов';
...
$_['help_product_ids']              = 'Добавьте идентификаторы продуктов, разделенные запятой (,), для которых метод не будет доступен.';
